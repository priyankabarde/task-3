...
//$this->registerJs(Yii::$app->request->baseUrl.'/js/site.js',$this::POS_READY);
                                            ...
                                            echo '  <tr style="padding:3px"><td>
                                                    <div class="row" style="border-style:dotted;background-color:#F5F5F5">
                                                        ...
                                                        <div class="col-md-4">
                                                                ...
                                                                <button type="button" class="btn btn-success btn-lg btn-block" style="position:relative;margin-top:30%;" onclick="window.location.href=\''.$coupon->Link.'\'">
                                                                        Grab Deal!
                                                                </button>
                                                        </div>
                                                    </div>
